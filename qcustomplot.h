...
public:
  ...
  */
  ...
  Q_SLOT void setSelectableParts(const QCPLegend::SelectableParts &selectableParts);
  Q_SLOT void setSelectedParts(const QCPLegend::SelectableParts &selectedParts);
